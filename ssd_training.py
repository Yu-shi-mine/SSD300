...
from data import make_datapath_list, OD_Dataset, DataTransform, Anno_xml2list, od_collate_fn
from model.ssd import SSD, MultiBoxLoss
...
if __name__ == '__main__':
    ...
    img_path = os.path.join(rootpath, 'img')
    img_extension = '.jpg'
    xml_path = os.path.join(rootpath, 'xml')
    division_ratio = 0.8
    train_img_list, train_anno_list, val_img_list, val_anno_list = make_datapath_list(
        img_path, img_extension, xml_path, division_ratio
    )
